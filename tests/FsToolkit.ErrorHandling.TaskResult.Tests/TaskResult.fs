...
let requireEqualToTests =
    testList
        "TaskResult.requireEqualTo Tests"
...
let requireNotEmptyTests =
    testList
        "TaskResult.requireNotEmpty Tests"
...
let defaultValueTests =
    testList
        "TaskResult.defaultValue Tests"
        [ testCase "defaultValue returns the ok value"
          <| fun _ ->
              let v =
                  TaskResult.defaultValue 43 (toTask (Ok 42))
          ...
          <| fun _ ->
              let v =
                  TaskResult.defaultValue 43 (toTask (Error err))
...
let defaultErrorTests =
    testList
        "TaskResult.defaultError Tests"
        [ testCase "defaultError returns the error value"
          <| fun _ ->
              let v =
                  TaskResult.defaultError 43 (toTask (Error 42))
          ...
          <| fun _ ->
              let v =
                  TaskResult.defaultError 43 (toTask (Ok 42))
...
let defaultWithTests =
    testList
        "TaskResult.defaultWith Tests"
        [ testCase "defaultWith returns the ok value"
          <| fun _ ->
              let v =
                  TaskResult.defaultWith (fun () -> 43) (toTask (Ok 42))
          ...
          <| fun _ ->
              let v =
                  TaskResult.defaultWith (fun () -> 42) (toTask (Error err))
    ...
    testList
        ...
        [ testCase "teeIf executes the function for ok and true predicate "
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeIf returnTrue bar (toTask (Ok 42))
          ...
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeIf returnFalse bar (toTask (Ok 42))
          ...
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeIf returnTrue bar (toTask (Error err))
    ...
    testList
        ...
        [ testCase "teeError executes the function for Error"
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeError bar (toTask (Error err))
    ...
    testList
        ...
        [ testCase "teeErrorIf executes the function for Error and true predicate "
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeErrorIf returnTrue bar (toTask (Error err))
          ...
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeErrorIf returnFalse bar (toTask (Error err))
          ...
          <| fun _ ->
              ...
              let result =
                  TaskResult.teeErrorIf returnTrue bar (toTask (Ok 42))
...
let catchTests =
    ...
    testList
        ...
        [ testCase "catch returns success for Ok"
          ...
          <| fun _ -> Expect.hasTaskErrorValueSync "unmapped" (TaskResult.catch f (toTask (Error "unmapped"))) ]

[<Tests>]
let zipTests =
    testList
        "TaskResult.zip tests"
        [ testCase "Ok, Ok"
          <| fun _ ->
              let v =
                  TaskResult.zip (toTask (Ok 1)) (toTask (Ok 2))
          ...
          <| fun _ ->
              let v =
                  TaskResult.zip (toTask (Ok 1)) (toTask (Error "Bad"))
          ...
          <| fun _ ->
              let v =
                  TaskResult.zip (toTask (Error "Bad")) (toTask (Ok 1))
          ...
          <| fun _ ->
              let v =
                  TaskResult.zip (toTask (Error "Bad1")) (toTask (Error "Bad2"))
...
let zipErrorTests =
    testList
        "TaskResult.zipError tests"
        [ testCase "Ok, Ok"
          <| fun _ ->
              let v =
                  TaskResult.zipError (toTask (Ok 1)) (toTask (Ok 2))
          ...
          <| fun _ ->
              let v =
                  TaskResult.zipError (toTask (Ok 1)) (toTask (Error "Bad"))
          ...
          <| fun _ ->
              let v =
                  TaskResult.zipError (toTask (Error "Bad")) (toTask (Ok 1))
          ...
          <| fun _ ->
              let v =
                  TaskResult.zipError (toTask (Error "Bad1")) (toTask (Error "Bad2"))
...
let TaskResultCETests =
    ...
    testList
        "TaskResult Computation Expression tests"
