...
[<assembly: AssemblyVersionAttribute("4.15.3")>]
[<assembly: AssemblyFileVersionAttribute("4.15.3")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "4.15.3"
    let [<Literal>] AssemblyFileVersion = "4.15.3"
