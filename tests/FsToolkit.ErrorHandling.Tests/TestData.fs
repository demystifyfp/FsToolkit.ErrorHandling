...
let invalidLatMsg =
    sprintf "%A is a invalid latitude value" 200.0
...
let invalidLngMsg =
    sprintf "%A is a invalid longitude value" 200.
...
let validTweet2R =
    Tweet.TryCreate "A link http://bit.ly/test"
...
let validURL =
    Url.TryCreate "http://bit.ly/test" |> okOrFail
...
let longerTweetErrMsg =
    "Tweet shouldn't contain more than 280 characters"
