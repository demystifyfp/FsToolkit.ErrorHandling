...
let requireFalseTests =
    testList
        "AsyncResult.requireFalse Tests"
...
let requireEqualToTests =
    testList
        "AsyncResult.requireEqualTo Tests"
...
let requireEqualTests =
    testList
        "AsyncResult.requireEqual Tests"
...
let requireEmptyTests =
    testList
        "AsyncResult.requireEmpty Tests"
...
let requireNotEmptyTests =
    testList
        "AsyncResult.requireNotEmpty Tests"
...
let defaultErrorTests =
    testList
        "AsyncResult.defaultError Tests"
        [ testCaseAsync "defaultError returns the error value"
          <| (let v =
                  AsyncResult.defaultError 43 (toAsync (Error 42))

              Expect.hasAsyncValue 42 v)

          testCaseAsync "defaultError returns the given value for Ok"
          <| (let v =
                  AsyncResult.defaultError 43 (toAsync (Ok 42))
...
let defaultWithTests =
    testList
        "AsyncResult.defaultWith Tests"
        [ testCaseAsync "defaultWith returns the ok value"
          <| (let v =
                  AsyncResult.defaultWith (fun () -> 43) (toAsync (Ok 42))

              Expect.hasAsyncValue 42 v)

          testCaseAsync "defaultValue invoks the given thunk for Error"
          <| (let v =
                  AsyncResult.defaultWith (fun () -> 42) (toAsync (Error err))
    ...
    testList
        ...
        [ testCaseAsync "tee executes the function for ok"
          ...
          <| async {
              ...
              let result =
                  AsyncResult.tee bar (toAsync (Error err))
    ...
    testList
        ...
        [ testCaseAsync "teeIf executes the function for ok and true predicate "
          <| async {
              ...
              let result =
                  AsyncResult.teeIf returnTrue bar (toAsync (Ok 42))
          ...
          <| async {
              ...
              let result =
                  AsyncResult.teeIf returnFalse bar (toAsync (Ok 42))
          ...
          <| async {
              ...
              let result =
                  AsyncResult.teeIf returnTrue bar (toAsync (Error err))
    ...
    testList
        ...
        [ testCaseAsync "teeError executes the function for Error"
          <| async {
              ...
              let result =
                  AsyncResult.teeError bar (toAsync (Error err))
          ...
          <| async {
              ...
              let result =
                  AsyncResult.teeError bar (toAsync (Ok 42))
    ...
    testList
        ...
        [ testCaseAsync "teeErrorIf executes the function for Error and true predicate "
          <| async {
              ...
              let result =
                  AsyncResult.teeErrorIf returnTrue bar (toAsync (Error err))
          ...
          <| async {
              ...
              let result =
                  AsyncResult.teeErrorIf returnFalse bar (toAsync (Error err))
          ...
          <| async {
              ...
              let result =
                  AsyncResult.teeErrorIf returnTrue bar (toAsync (Ok 42))
...
let asyncResultCETests =
    ...
    testList
        "asyncResult Computation Expression tests"
