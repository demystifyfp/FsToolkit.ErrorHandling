    ...
    testList
        ...
        [ testCase "traverseResult with a list of valid data"
          <| fun _ ->
              ...
              let actual =
                  List.traverseResultM Tweet.TryCreate tweets
    ...
    testList
        ...
        [ testCase "traverseResult with a list of valid data"
          <| fun _ ->
              ...
              let actual =
                  List.sequenceResultM (List.map Tweet.TryCreate tweets)
    ...
    testList
        ...
        [ testCase "traverseResultA with a list of valid data"
          <| fun _ ->
              ...
              let actual =
                  List.traverseResultA Tweet.TryCreate tweets
    ...
    testList
        ...
        [ testCase "traverseResult with a list of valid data"
          <| fun _ ->
              ...
              let actual =
                  List.sequenceResultA (List.map Tweet.TryCreate tweets)
...
let traverseValidationATests =
    testList
        "List.traverseValidationA Tests"
...
let sequenceValidationATests =
    ...
    testList
        "List.sequenceValidationA Tests"
        [ testCase "traverseValidation with a list of valid data"
          <| fun _ ->
              ...
              let actual =
                  List.sequenceValidationA (List.map tryCreateTweet tweets)
...
let traverseAsyncResultMTests =
    ...
    testList
        "List.traverseAsyncResultM Tests"
...
let traverseAsyncResultATests =
    ...
    testList
        "List.traverseAsyncResultA Tests"
...
let sequenceAsyncResultMTests =
    ...
    testList
        "List.sequenceAsyncResultM Tests"
...
let sequenceAsyncResultATests =
    ...
    testList
        "List.sequenceAsyncResultA Tests"
