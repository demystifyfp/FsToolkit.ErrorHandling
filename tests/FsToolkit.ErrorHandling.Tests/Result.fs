...
let resultCETests =
    testList
        "result Computation Expression tests"
...
let defaultWithTests =
    testList
        ...
        [ testCase "defaultWith returns the ok value"
          <| fun _ ->
              let v =
                  Result.defaultWith (fun () -> 43) (Ok 42)
          ...
          <| fun _ ->
              let v =
                  Result.defaultWith (fun () -> 42) (Error err)
    ...
    testList
        ...
        [ testCase "teeErrorIf executes the function for Error and true predicate "
          <| fun _ ->
              ...
              let result =
                  Result.teeErrorIf returnTrue bar (Error err)
          ...
          <| fun _ ->
              ...
              let result =
                  Result.teeErrorIf returnFalse bar (Error err)
    ...
    testList
        ...
        [ testCase "valueOrTests returns the value if Ok"
          ...
          <| fun _ ->
              ...
              let value =
                  res |> Result.valueOr (fun err -> "foo" + err)
...
let zipErrorTests =
    testList
        ...
        [ testCase "Ok, Ok"
          ...
          <| fun () ->
              let actual =
                  Result.zipError (Error "Bad1") (Error "Bad2")
