...
let zipTests =
    testList
        ...
        [ testCase "Ok, Ok"
          ...
          <| fun () ->
              let actual =
                  Validation.zip (Ok 1) (Validation.error "Bad")

              Expect.equal actual (Error [ "Bad" ]) "Should be Error"
          testCase "Error, Ok"
          <| fun () ->
              let actual =
                  Validation.zip (Validation.error "Bad") (Ok 1)

              Expect.equal actual (Error [ "Bad" ]) "Should be Error"
          testCase "Error, Error"
          <| fun () ->
              let actual =
                  Validation.zip (Validation.error "Bad1") (Validation.error "Bad2")
