...
module AsyncResultCE =
    ...
    type AsyncResultBuilder() =
        ...
        member __.Delay(generator: unit -> Async<Result<'T, 'TError>>) : Async<Result<'T, 'TError>> =
        ...
        member this.While
            (
                guard: unit -> bool,
                computation: Async<Result<unit, 'TError>>
        ...
        member this.For(sequence: #seq<'T>, binder: 'T -> Async<Result<unit, 'TError>>) : Async<Result<unit, 'TError>> =
            this.Using(
